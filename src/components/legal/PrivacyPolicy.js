...
const PrivacyPolicy = () => {
    return(
        <div className="legal">
            ...
            <hr/>
            <p>ScaleHaus, LLC (“company”, “I”, “we” or “us”) is dedicated to respecting the privacy of your personal information, and this privacy policy describes what information is collected from you on scale.haus (hereinafter the “website”) and how it is used. The term “you” refers to anyone who uses, visits and/or views the website.
            ...
            <p>We respect the privacy of children and “child” means an individual under the age of 13. All information and content on this website is intended for individuals over the age of 18. Children under the age of 13 are prohibited from using this website. We do not knowingly collect, use or disclose personal information from children under the age of 13 without prior parental or guardian consent. If you believe personal information is collected from someone under the age of 13 without parental or guardian consent, then please contact us to have that information deleted.</p>
            
            <h1>WHAT INFORMATION WE COLLECT AND HOW IT IS USED</h1>

            <p>When you access the website, you may provide certain personally identifiable information including but not limited to your name, email address, phone number, address, avatar image, credit card information when you make a purchase on the website.
            ...
            <p>Your personal information is used to personalize your experience, improve the website to better serve you, provide customer service support, efficiently process your requests or transactions, tailor advertisements to you, elicit reviews of services or products, provide you offers, promotions and to follow up with you through correspondence (email, live chat, or phone).</p>
            <p>We may also use this information to provide you offers and promotions from our partners and/or our affiliates in exchange for a commission without additional cost to you.</p>
            ...
            <h1>COMMENTS AND SOCIAL MEDIA</h1>
            ...
            <p>We may use cookies for various reasons such as optimizing and personalizing your browsing experience, checking our website analytics, saving your preferences and settings for future use, serving ads based on your liking and interests, affiliate marketing and for posting comments on our website.</p>
            <p>This information is only collected to better serve and understand your user experience on the website.  You have the option of turning off cookies on your computer should you wish to do so. If you choose to do that, you may not be able to view all features and content of this website.</p>
            <h1>USE OF WEB BEACONS AND PIXELS</h1>
            ...
            <h1>THIRD PARTY LINKS AND USE</h1>
            ...
            <p>If you are in the European Union and opt in to receive any of our free products or services and/or purchase any products or services through our website then you will be subscribed to receive our free email newsletter once you affirmatively consent to it. Please see Opt Out section below should you wish to “unsubscribe” and not receive any emails from us.</p>
            <p>But if you are NOT in the European Union then you will be automatically subscribed to receive our free email newsletter once you opt in to receive any of our free products or services and/or purchase any products or services through our website. Please see Opt Out section below should you wish to “unsubscribe” and not receive any emails from us.</p>
            
            <h1>OPT OUT</h1>

            <p>We comply with the CAN-SPAM Act of 2003 and do not spam or send misleading information. Should you wish to no longer receive communication from us, you have the option of unsubscribing by clicking “unsubscribe” in the bottom of the email we send to you or by contacting us.</p>
            <p>As for third party websites, please contact them directly to unsubscribe and/or opt out from their communications.
            We are in compliance with the GDPR along with the email marketing service we use to collect your data.</p>

            <h1>GDPR VISITOR RIGHTS</h1>

            <p>Under the GDPR, if you are within the European Union, you are entitled to certain rights and information listed below.
            We will retain any information you choose to provide to us until the earlier of:</p>
            <ol>
            <li>You ask us to delete the information by sending a request to sparlor@scale.haus. Please note that such requests may result in you no longer being able to access paid or free content previously provided to you.</li>
            ...
            <p>You have the rights to either rectify or erase your personal data. You have the right to verify the accuracy of your personal data and have it corrected or removed completely</p>
